<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeBehind="ReportViewer.aspx.cs"
    Inherits="API.Reports.ReportViewer" Title="Report Viewer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="chpInfHead" runat="server">
    ...
    <script src="<%= ResolveUrl("~/gridscripts/ReportViewerParameterSelectorMultiselect.js") %> "
        type="text/javascript"></script>
    <script src="<%= ResolveUrl("~/gridscripts/ErrorList.js") %> " type="text/javascript"></script>
    <script type="text/javascript">
        ...
        function OpenSendMailPopupDialog() {
    ...
    <div class="form-wrapper">
        ...
        <div class="form-details">
            ...
            <div style="float: right; width: 30%; padding-top: 5px; padding-right: 48px;">
                ...
                <div class="btnRight">
                    <input type="submit" class="button" onclick="OpenSendMailPopupDialog(); return false;"
                        value="Log File" />
                </div>
                <div class="btnRight">
