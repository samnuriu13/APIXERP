...
namespace API.UI.Security
{
    public partial class SecurityRuleInfo : PageBase
    {
        ...
        CustomList<SECURITY.DAO.SecurityRule> objSecurityRuleList = new CustomList<SECURITY.DAO.SecurityRule>();
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (SecurityRuleList.Count != 0)
            {
                ...
                foreach (SECURITY.DAO.SecurityRule sR in objSecurityRuleList)
                {
