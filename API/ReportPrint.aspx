<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeBehind="ReportPrint.aspx.cs"
    Inherits="API.Reports.ReportPrint" Title="Report viewer" %>
        ...
        <div id="divLoginUpper">
            ...
            <div class="divLoginContent1">
                <fieldset class="fsPadding5px fs">
                    ...
                    <div class="lblAndTxtStyle1">
                        <div class="divlblwidth100px bglbl">
                            <asp:RadioButton ID="rbPortrait" runat="server" Text="Portrait" Checked="true" GroupName="layout" style="font-size:12px"/>
                        </div>
                        <div class="divlblwidth100px bglbl">
                            <asp:RadioButton ID="rbLandscape" runat="server" Text="Landscape" GroupName="layout" style="font-size:12px"/>
                        </div>
                    </div>
                ...
                <fieldset class="fsPadding5px fs">
                    ...
                    <div class="lblAndTxtStyle1">
                        <div class="divlblwidth100px bglbl">
                            <asp:RadioButton ID="rbAllPages" runat="server" Text="All Pages" GroupName="PrintRange" Checked="true" style="font-size:12px"/>
                        </div>
                    </div>
                    <br />
                    <div class="lblAndTxtStyle1">
