...
(
	function () {
	    jQuery('#grdBankBranch').jqGrid
		(
			{
			    url: rootPath + 'GridHelperClasses/GridGenericHandler.ashx?jqGridID=grdBankBranch&SessionVarName=Bank_BankBranchList'
				, editurl: rootPath + 'GridHelperClasses/GridGenericHandler.ashx?jqGridID=grdBankBranch&editMode=1&SessionVarName=Bank_BankBranchList'
				, datatype: 'json'
				, page: 1
				, colNames: ['VID', 'Name', 'Short Name', 'Address','Contract Person']
				, colModel:
					[
				...
				, rownumbers: true
				, scrollrows: true
				, pager: jQuery('#grdBankBranch_pager')
		...
		(
            ...
            , jQuery('#grdBankBranch').getGridParam('editDialogOptions')
   			, jQuery('#grdBankBranch').getGridParam('addDialogOptions')
		);
