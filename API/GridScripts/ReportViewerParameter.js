		...
		(
			{
				...
				, afterEditCell: function (id, name, val, iRow, iCol) {
				    ...
				    if (data.DataType == "DateTime" || data.DataType == "System.DateTime" || data.ColumnName == "DateOfJoinFrom" || data.ColumnName == "DateOfJoinTo" || data.ColumnName == "Date" || data.ColumnName == "FromDate" || data.ColumnName == "ToDate" || data.ColumnName == "AsOnDate" || data.ColumnName == "Workdate" || data.ColumnName == "PreviousDate" ||  data.ColumnName == "DateOfCruuentMonth" ||data.ColumnName == "DateOfPreviousMonth" )
